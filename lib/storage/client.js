...
export default class Client extends CryptoConsumer {
  ...
  async replaceNoteByName(data, recipientEncryptionKey, recipientSigningKey, options) {
    ...
    let encryptedNote = await this.constructor.internalCreateEncryptedNote(
      data,
      recipientEncryptionKey,
      recipientSigningKey,
      encryptionKeys,
  ...
  static async internalWriteNote(
    ...
    let encryptedNote = await this.internalCreateEncryptedNote(
      data,
      recipientEncryptionKey,
      recipientSigningKey,
      encryptionKeyPair,
  ...
  static async internalCreateEncryptedNote(
    data,
    recipientEncryptionKey,
    recipientSigningKey,
    encryptionKeyPair,
