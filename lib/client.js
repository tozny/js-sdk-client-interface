...
import { default as Note } from './types/note'
import { default as CoreNote } from './types/coreNote'
import { default as NoteOptions } from './types/noteOptions'
...
const PreClient = crypto => {
  ...
  class Client {
    ...
    static async readNote(
      ...
      let anonAuth = await AuthRequest.anonymousAuth(
        crypto,
        signingKeyPair.publicKey,
        signingKeyPair.privateKey,
        apiUrl
      )
      return Client.internalReadNote(anonAuth, encryptionKeyPair, noteId, apiUrl)
    }
