...
export default class NoteOptions extends Serializable {
  constructor(clientId, maxViews, nameId, expiration) {
    super()

    this.clientId = clientId
    this.maxViews = maxViews
    this.nameId = nameId // User defined id (id_string) available as part of premium features.
  ...
  static decode(json) {
    ...
    let nameId = json.id_string === undefined ? null : json.id_string
    let expiration = json.expiration === undefined ? null : json.expiration
    return new NoteOptions(clientId, maxViews, nameId, expiration)
  }
}
