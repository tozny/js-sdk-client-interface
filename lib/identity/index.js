...
export default class Identity extends CryptoConsumer {
  ...
  /**
   * Gets the Config constrcutor for creating Identity configuration objects.
   *
   ...
   * Tozny Storage Secure Note. This note is fetchable using the username/password derived keys.
   *
   ...
   * credentials anc create a Client instance.
   *
